<?php
    session_start();
    if (isset($_POST['lastname']) && isset($_POST['surname']) && isset($_POST['mail']) && isset($_POST['city']) && isset($_POST['region']) && isset($_POST['jobTitle']) && isset($_POST['education']) && isset($_POST['workexperience']) && isset($_POST['password'])) {
       ...
       curl_setopt_array($curl, array(
         CURLOPT_URL => 'http://localhost:3000/People/7',
